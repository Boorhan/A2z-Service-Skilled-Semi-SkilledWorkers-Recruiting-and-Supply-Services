...
@section('title', 'SP Pending Orders')
            ...
            <div class="col p_0" >
                ...
                <div class="row">
                    <div class="col-12 service-col">
                      @if($sp_C_pending_order <1)
                          <div class="service-details-content" style="padding:10px 20px;">
                              You don't have any ongoing orders.
                           </div> 
                        
                          @elseif($sp_C_pending_order >=1)
                            <h5 style="margin-top: 15px;" class="myOrderH4">My Incomplete Orders</h5>
                            @foreach($sp_pending_order_list as $my_order)
                              <div class="service-details-content" style="padding:0px 20px;">
                                <div class="row">
                                    ...
                                    <div class="col-3 col-sm-2" style="display: flex;justify-content: center;align-items: center;">
                                        ...
                                        @if($my_order->order_status_no ==1)
                                            <a href="{{ url('sp-staus-change-ongoing/'.$my_order->service_slug.'/'.$my_order->service_request_no)}}" style="margin-left:10px" data-toggle="tooltip" data-placement="bottom" title="Change Status To Ongoing"><i class="fa fa-cogs text-primary" aria-hidden="true"></i></a>
                                        @elseif($my_order->order_status_no ==2)
                                            <a href="{{ url('sp-staus-change-complete/'.$my_order->service_slug.'/'.$my_order->service_request_no)}}" style="margin-left:10px" data-toggle="tooltip" data-placement="bottom" title="Change Status To Complete"><i class="fa fa-cogs text-primary" aria-hidden="true"></i></a>
                                        @endif
                                    </div>
                                </div>
                              </div>
