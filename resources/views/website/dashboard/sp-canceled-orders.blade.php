            ...
            <div class="col p_0" >
                ...
                <div class="row">
                    <div class="col-12 service-col">
                      @if($sp_allCancled_order <1)
                          <div class="service-details-content" style="padding:10px 20px;">
                              You haven't canceled any order yet.
                           </div> 
                        
                          @elseif($sp_allCancled_order >=1)
                            <h5 style="margin-top: 15px;" class="myOrderH4">My Completed Orders</h5>
                            @foreach($sp_canceled_order_list as $my_order)
                                    ...
                                    <div class="col-9 col-sm-10">
                                        <div class="row" style="#padding: 0px 15px">
                                          ...
                                          <div class="col-8 service-right">
                                            ...
                                            <p>{{$my_order->category_name}} | {{$my_order->sub_category_name}} |  Status: <span class="badge badge-danger">Canceled by Me</span>
                                            </p>
