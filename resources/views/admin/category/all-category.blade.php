                  ...
                  <tbody>
                    ...
                    @foreach($categories as $row)
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;"><a href="{{asset('public/uploads/'.$row->category_image)}}" target="_blank"><img src="{{asset('public/uploads/'.$row->category_image)}}" class="img-responsive"></a></td>
