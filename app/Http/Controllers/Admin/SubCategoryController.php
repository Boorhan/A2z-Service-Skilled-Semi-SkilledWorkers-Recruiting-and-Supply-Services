...
class SubCategoryController extends Controller
{
  ...
  //   //delete category
    public function deleteSubCategory($id){
    	...
    	$get_image = DB::table('subcategories')->where('subcategory_no',$id)->first();
    	$image = public_path()."/public/uploads/".$get_image->sub_category_image; //this line for removing image from uploads folder
    	$delete_subcat = DB::table('subcategories')->where('subcategory_no',$id)->update($data);
    	if($delete_subcat){
    		unlink($image);  //this line for removing image from uploads folder
	        $notification=array(
