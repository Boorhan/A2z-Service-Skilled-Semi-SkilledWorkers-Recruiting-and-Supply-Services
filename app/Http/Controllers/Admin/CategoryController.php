...
class CategoryController extends Controller
{
    ...
    public function deleteCategory($id){
    	...
    	$get_image = DB::table('categories')->where('category_no',$id)->first();
    	$image = public_path()."/public/uploads/".$get_image->category_image; //this line for removing image from uploads folder
